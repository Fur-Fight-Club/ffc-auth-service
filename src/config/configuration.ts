export default () => ({
  app_port: 4002 ?? process.env.APP_PORT,
  service: "ffc-auth-service",
  issuer: "http://10.102.3.34:4002" ?? process.env.ISSUER,
  authorizedServices: [
  ...
  ffc_notifications_url:
    "http://localhost:4003" ?? process.env.FFC_NOTIFICATIONS_URL,
